...
def display_instances(image, boxes, masks, class_ids, class_names, frame_index, scores=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--show', default=False, action="store_false", help='Show output')
    ...
    while cap.isOpened():
        ...
        r = results[0]
        frame+=1
        image = display_instances(image, r['rois'], r['masks'], r['class_ids'], class_names, frame, r['scores'])
        if args.show:
